<%@ Page Title="" Language="C#" MasterPageFile="~/E-Medicines Services.master" AutoEventWireup="true" CodeFile="UserProfile.aspx.cs" Inherits="UserProfile" %>
        ...
        function ProfileValidation() {
            ...
            if (document.getElementById("btnPrfl").value.toString() == "UPDATE PROFILE") {
                if (document.getElementById("txtFrstnm").value.length < 1) {
                    ...
                    document.getElementById("lblError").innerHTML = "Mobile Number Must Not Be Empty.";
                }
                else if (!DigitValidation(document.getElementById("txtMono").value)) {
                    document.getElementById("lblError").innerHTML = "Enter Valid Mobile Number.";
                }
